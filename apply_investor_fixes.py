...
print("🔧 Applying investor feedback fixes...")

# ===== FIX 1: INSTALL CELL (subprocess.check_call) =====
install_source = [
    "# @title 🚀 Install & Setup (v2.1.1 Enforced) { display-mode: \"form\" }\n",
    "import sys\n",
    "import time\n",
    "import subprocess\n",
    ...
    "\n",
    "print(f\"🚀 Installing EPI Recorder v{REQUIRED_VERSION}...\")\n",
    "\n",
    "start = time.time()\n",
    "\n",
    ...
    "    display(HTML(f'<h1 style=\"color: #10b981;\">✅ EPI Recorder v{REQUIRED_VERSION} Ready</h1>'))\n",
    "    print(f\"⏱️  Setup Time: {time.time() - start:.1f}s\")\n",
    "    print(f\"📦 Source: PyPI (Official Release)\")\n",
    "    print(\"=\"*70)\n",
    "else:\n",
    "    display(HTML(f'<h1 style=\"color: #f59e0b;\">⚠️ Version Mismatch</h1>'))\n",
...
record_source = [
    "# @title 🎬 Record & Download { display-mode: \"form\" }\n",
    "import time\n",
    "import os\n",
    "import subprocess\n",
    ...
    "\n",
    "display(HTML('<h1 style=\"color: #3b82f6;\">🎬 RECORDING...</h1>'))\n",
    "\n",
    "# 1. Clean slate\n",
    "!rm -rf epi-recordings/*.epi 2>/dev/null\n",
    "!rm -f *.epi 2>/dev/null\n",
    "\n",
    "print(\"📹 Capturing AI execution (Cryptographic Signing Active)...\")\n",
    ...
    "        print(\"⚠️ Warning during recording:\")\n",
    "        print(result.stderr)\n",
    "\n",
    "except subprocess.TimeoutExpired:\n",
    "    print(\"⚠️ Process timed out (forcing save)...\")\n",
    "\n",
    ...
    "    \n",
    "    print(\"\\n\" + \"=\" * 70)\n",
    "    display(HTML(f'<h2 style=\"color: #10b981;\">✅ RECORDING COMPLETE: {epi_file.name}</h2>'))\n",
    "    print(f\"📦 Evidence Size: {size_kb:.2f} KB\")\n",
    "    print(f\"⏱️ Duration: {elapsed:.1f}s\")\n",
    "    print(\"=\" * 70)\n",
    "    \n",
    "    # 4. Robust Download\n",
    "    print(\"\\n⬇️ Downloading proof to your machine...\")\n",
    "    try:\n",
    ...
    "else:\n",
    "    display(HTML('<h2 style=\"color: #ef4444;\">❌ Recording Failed</h2>'))\n",
    "    print(\"Debug Output:\")\n",
    "    if 'result' in locals():\n",
    "        print(result.stdout)\n",
    "        print(result.stderr)\n"
...
viewer_source = [
    "# @title 🖥️ Launch Viewer { display-mode: \"form\" }\n",
    "import zipfile\n",
    "import json\n",
    "import html\n",
    "import os\n",
    ...
    "\n",
    "print(f\"🔓 Decrypting Container: {epi_file}...\")\n",
    "\n",
    ...
    "                \n",
    "                if(kind.includes('MARKET')) {{ icon = '📈'; color = 'bg-blue-50 text-blue-600 border-blue-100'; }}\n",
    "                if(kind.includes('RISK')) {{ icon = '🛡️'; color = 'bg-orange-50 text-orange-600 border-orange-100'; }}\n",
    "                if(kind.includes('EXECUTION')) {{ icon = '🚀'; color = 'bg-green-50 text-green-600 border-green-100'; }}\n",
    "                if(kind.includes('SYSTEM')) {{ icon = '⚙️'; color = 'bg-gray-50 text-gray-400 border-gray-100'; }}\n",
    "\n",
    "                // Build Card\n",
...
for cell in nb['cells']:
    ...
    if cid == 'install':
        ...
        print("   ✅ Fixed Cell 1 (Install) - subprocess.check_call")
    elif cid == 'record':
        cell['source'] = record_source
        print("   ✅ Fixed Cell 3 (Record) - subprocess.run with timeout")
    elif cid == 'viewer':
        cell['source'] = viewer_source
        print("   ✅ Fixed Cell 4 (Viewer) - SaaS UI with Tailwind + JS")
