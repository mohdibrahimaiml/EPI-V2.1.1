# EPI Protocol: The "Hybrid" Master Demo
**Strategy:** "Visual Drama" (for attention) + "Infrastructure Truth" (for conviction).
**Narrative:** From "Logging" -> "Digital Public Infrastructure (DPI) for AI."

---

## Cell 1: [Markdown] The Hook ($920M Problem)
...
## Cell 3: [Markdown] Agent Execution (Notarization)
...
## Cell 4: [Code] The "Anti-Logger" Agent
...
## Cell 5: [Markdown] Verification (The "Trust" Primitive)
...
## Cell 7: [Markdown] The Viewer ("Forensics")
...
## Cell 9: [Markdown] The Security Test (The "Killer Feature")
...
## Cell 10: [Code] The "Bit-Flip" (Robust)
...
## Cell 11: [Markdown] The Rainmatter Pitch
